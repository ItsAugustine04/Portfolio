...
SUPABASE_URL = "https://fqwgfuqyczxuwgalmssj.supabase.co" # Replace with your Supabase URL
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZxd2dmdXF5Y3p4dXdnYWxtc3NqIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2Nzg2MTEzNywiZXhwIjoyMDgzNDM3MTM3fQ.VtFLRsu9OtDmIK8-K4X4y-cohQ1K-YWOx5nZvAp-tK8" # Replace with your Supabase API key

supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)

bucket_name = "image1" # Name of the bucket to be created
image_path = "PES2UG23CS107.png"  # Replace with the local image path
image_name = "PES2UG23CS107.png"  # Desired name for the uploaded file
